    ...
    const examData = [
      {
        ...
        examCode: 'CompTIA A+ Core 1',
        examName: 'CompTIA A+ Certification Exam: Core 1',
      ...
      },
      {
        id: generateExamId(),
        vendorId: vendorData[0].id, // CompTIA
        examCode: 'CompTIA Network+',
        examName: 'CompTIA Network+ Certification Exam',
      ...
      },
      {
        ...
        examCode: 'CCNA 200-301',
        examName: 'Cisco Certified Network Associate',
